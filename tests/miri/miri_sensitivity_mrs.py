...
np.savez('../../outputs/miri_mrs_sensitivity.npz',
    ...
    sat_limits=output[0]['sat_limits'], configs=output[0]['configs'], line_limits=output[0]['line_limits'])
...
np.savez('../../outputs/miri_mrs_sensitivity_one.npz',
    ...
    sat_limits=output[1]['sat_limits'], configs=output[1]['configs'], line_limits=output[1]['line_limits'])
